...
def pre_handle1(raw_data):
    ...
    print("数据已预处理")
    return data
path1=r"D:\my bad\CSI_DATA\test.dat"
path2=r"D:\my bad\CSI_DATA\test.dat"
path3=r"D:\my bad\CSI_DATA\test.dat"
data1=get_data(path1)
# data2=get_data(path2)
# data3=get_data(path3)
data4=get_data(path1)
data5=get_data(path1)
data6=get_data(path3)

data1=pre_handle(data1)
# data2=pre_handle(data2)
# data3=pre_handle(data3)
data4=pre_handle(data4)
data5=pre_handle1(data5)
